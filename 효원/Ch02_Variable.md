...
### 진법
+ 2진법: 0과 1로만 데이터를 표현
+ 10진법: 10개의 숫자로 데이터를 표현
+ 8진법: 값을 표현하는데 8개의 기호 필요 -> 0~7의 숫자를 기호로 사용
+ 16진법: 16개의 기호 필요 -> 0~9, A~F를 기호로 사용
#### 2진수 -> 8진수, 16진수로 변환
+ 2->8 ) 2진수를 뒤에서부터 3자리씩 끊어서 그에 해당하는 8진수로 변환
+ 2->16 ) 2진수를 뒤에서부터 4자리씩 끊어서 그에 해당하는 16진수로 변환
#### 실수의 진법 변환
+ 10진 소수점수 -> 2진 소수점수로 변환
![img_13.png](img_13.png)
정수부만 위에서 아래로 적고 앞에 0을 붙임
+ 2진 소수점수 -> 10진 소수점수로 변환 
